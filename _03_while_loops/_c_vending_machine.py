...
if __name__ == '__main__':
    ...
    while money_in_dollars > 0:
        ...
        if money_spent == 0:
            messagebox.showinfo(title=None, message="You have $" + str(money_in_dollars) + " left.")
            break
    ...
    if money_in_dollars == 0:
        messagebox.showinfo(title="Congratulations!", message="Congrats! You have maximized your money!")
    # TODO) If there is a negative amount of money, tell the user they
    #  overspent!
    if money_in_dollars < 0:
        messagebox.showinfo(title="Womp womp!", message="You have overspent and are now out of money.")
